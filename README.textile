...
Il suffit d’utiliser le plugin d’installation : ‘./bin/plugin -u http://jotitan.free.fr/download/elasticsearch-analyzers-compare-plugin-1.0.3.zip -i elasticsearch-analyzers-compare-plugin’.
